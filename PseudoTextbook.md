...
4. [Applied math and machine learning basics](https://www.deeplearningbook.org/contents/part_basics.html): ...else if you have time, can bring yourself up to speed with linear algebra and other useful topics here
